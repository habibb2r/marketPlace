...
const ManageOrders = () => {
  ...
  return (
    <div>
      <SectionTitle title="Manage Orders" ico={ico} ict={ict}></SectionTitle>
      <div className="px-1 grid md:grid-cols-2 py-5 gap-5">
        {getOrderSeller?.map((order) => (
          <div
            className="px-3 py-4 shadow-md shadow-success rounded-md relative pb-[70px] bg-accent bg-opacity-15"
            key={order._id}
          >
            <div className="flex flex-col justify-start gap-4">
                  ...
                  >
                    <p className="w-[270px] md:w-[400px] font-semibold font-mono flex items-start gap-1">
                      <span className="text-secondary">
                        <AiFillProduct className="text-xl text-error" />
                      </span>{" "}
                      <span>
                        {item} ({order.product_prices[index]} tk)
                      </span>
                    </p>
              ...
              <div className="flex justify-between items-center gap-2 font-mono">
                ...
                <p className="flex items-center gap-1">
                  <MdProductionQuantityLimits className="text-xl text-error" />
                  <span>
              ...
              <div className="font-mono">
                <div className="flex items-center gap-1 ">
                  <FaUserAlt className="text-xl text-error" />
                  <span>
              ...
              <div className="font-mono flex flex-col items-start px-2 bg-primary bg-opacity-20 rounded-md py-2 gap-2">
                <div className="flex justify-between items-center gap-3 md:gap-10">
                  <div>
                    <p className="flex items-center gap-3 font-semibold">
                      <div className="flex items-center gap-1">
                        <span>
                          <MdPayment className="text-xl text-error" />
                        </span>
                  ...
                  <div className="font-mono">
                    <p className="flex items-center gap-3 font-semibold">
                      <div className="flex items-center gap-1">
                        <TbTruckDelivery className="text-xl text-error" />{" "}
                ...
                <div className="flex items-center gap-1">
                  <GiIdCard className="text-xl text-error" />
                  <span>
