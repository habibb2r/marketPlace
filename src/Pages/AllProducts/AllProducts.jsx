      ...
      <div>
        <div className="flex justify-between items-center">
          <label className="input input-primary input-bordered flex items-center gap-2">
            ...
            <button className="text-2xl"><TbShoppingBagSearch></TbShoppingBagSearch></button>
          </label>

          <select defaultValue={'All'} onClick={handleFilter} className="select select-primary select-bordered w-full max-w-xs">
            <option value={'All'}>
              All Products
            </option>
            {
          ...
          <select defaultValue={0} onClick={handleSorting} className="select select-primary w-full max-w-xs">
        ...
        <div>
            ...
            <div className="pt-10 grid grid-cols-4 gap-10">
                {
                    allProducts.map(product=> <Cards key={product._id} data={product}></Cards> )
                }
