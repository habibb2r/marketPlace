  ...
  return (
    <div className="py-5">
      ...
      <div className=" flex flex-col lg:flex-row justify-center overflow-hidden pb-10 gap-4 px-1">
        ...
        <AttentionSeeker  effect="pulse"  className="shadow-md shadow-primary w-[100%] rounded-3xl hover:shadow-xl hover:shadow-success hover:transition-shadow border  bg-secondary bg-opacity-5">
